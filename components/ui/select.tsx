...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-9 w-full items-center justify-between gap-2 rounded-xl border border-border bg-input px-3 py-2",
      "text-sm text-foreground shadow-sm ring-offset-background placeholder:text-muted-foreground",
